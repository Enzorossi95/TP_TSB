...
public class TSB_DAHashTable<K, V> implements Map<K, V>, Cloneable, Serializable {
     ...
     */
    public TSB_DAHashTable(int initial_capacity) {
     ...
     */
    public TSB_DAHashTable(int initial_capacity, float load_factor) {
        if (load_factor <= 0) {
            load_factor = 0.75f;
        }
        if (initial_capacity <= 0) {
            ...
            if (initial_capacity > TSB_DAHashTable.MAX_SIZE) {
                initial_capacity = TSB_DAHashTable.MAX_SIZE;
            } else {
     ...
     */
    public TSB_DAHashTable(Map<? extends K, ? extends V> t) {
        this(53, 0.75f);
        this.putAll(t);
    }
     ...
     * Tercero
     * 
     * Definir dentro de la clase TSB_DAHashTable una clase interna Entry que
     ...
     * CUARTO
     * 
     * Definir dentro de la clase TSB_DAHashTable las tres clases internas para
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        @Override
        public int size() {
            return TSB_DAHashTable.this.count;
        }

        @Override
        public boolean contains(Object o) {
            return TSB_DAHashTable.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return (TSB_DAHashTable.this.remove(o) != null);
        }

        @Override
        public void clear() {
            TSB_DAHashTable.this.clear();
        }
        ...
        private class KeySetIterator implements Iterator<K> {
            ...
            public KeySetIterator() {
                ...
                current_entry = -1;
                next_ok = false;
                expected_modCount = TSB_DAHashTable.this.modCount;
            }
            ...
            public boolean hasNext() {
                ...
                Entry<K, V> t[] = TSB_DAHashTable.this.table;
                            int s[] = TSB_DAHashTable.this.states;
            ...
            public K next() {
                ...
                if (TSB_DAHashTable.this.modCount != expected_modCount) {
            ...
            public void remove() {
                ...
                TSB_DAHashTable.this.table[current_entry] = null;
                TSB_DAHashTable.this.states[current_entry] = 2;
                ...
                TSB_DAHashTable.this.count--;

                // fail_fast iterator: todo en orden...
                TSB_DAHashTable.this.modCount++;
                expected_modCount++;
            }
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            int ih = TSB_DAHashTable.this.h(entry.getKey());
            int ic = ih;
            int j = 1;
    ...
    private class ValueCollection extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return TSB_DAHashTable.this.containsValue(o);
        }
    ...
    /**
     * QUINTO Redefinir en la clase TSB_DAHashTable los métodos equals(),
    ...
    {
        // Se crea una nueva instancia de TSB_DAHashTable
        TSB_DAHashTable<K, V> t = new TSB_DAHashTable<>(this.table.length, this.load_factor);
    ...
    /**
     * Sexto Definir en la clase TSB_DAHashTable los métodos rehash() y
    ...
    protected void rehash()
    {
        ...
        if(new_length > TSB_DAHashTable.MAX_SIZE)
            new_length = TSB_DAHashTable.MAX_SIZE;
